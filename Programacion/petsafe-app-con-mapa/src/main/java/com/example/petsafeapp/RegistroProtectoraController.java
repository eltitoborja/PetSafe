...
/**
 * Controlador para la vista de registro de una protectora.
 * Gestiona el formulario para que un usuario registre una nueva cuenta de tipo protectora,
 * incluyendo la validación de datos, la interacción con la base de datos para crear el usuario y la protectora,
 * y la navegación a la pantalla de inicio de sesión tras un registro exitoso.
 */
public class RegistroProtectoraController {
  /**
  * Panel raíz de la vista de registro de protectora.
  ...
  */
  ...
  /**
  * Campo de texto para el correo electrónico de la protectora.
  */
  @javafx.fxml.FXML
  private TextField emailTextField;
  /**
  * Campo de texto para el nombre del responsable o de usuario asociado a la protectora.
  */
  @javafx.fxml.FXML
  ...
  */
  ...
  /**
  * Campo de texto para la dirección de la protectora.
  */
  @javafx.fxml.FXML
  private TextField direccionTextField;
  /**
  * Campo de texto para la descripción de la protectora.
  */
  @javafx.fxml.FXML
  private TextField descripcionTextField;
  /**
  * Campo de texto para el número de teléfono de contacto de la protectora.
  */
  @javafx.fxml.FXML
  private TextField telefonoTextField;
  /**
  * ImageView que muestra una vista previa de la foto seleccionada para la protectora.
  */
  @javafx.fxml.FXML
  private ImageView fotoImageView;

  /**
  * Archivo de la imagen seleccionada para la foto de la protectora.
  */
  private File imgFile;


  /**
  * Maneja el evento de clic en el botón "Registrar Protectora".
  * Realiza la validación de los campos del formulario, verifica la existencia del email,
  * crea un nuevo usuario y una nueva protectora en la base de datos si los datos son válidos,
  ...
  */
  @javafx.fxml.FXML
  public void onRegistrarProtectoraButtonClick(ActionEvent actionEvent) throws IOException, SQLException, PacketTooBigException {
    ...
    try {
      ...
      if (sb.indexOf("-") >= 0) {
        ...
        // CREAR NEGOCIO EN LA BASE DE DATOS (ACABAR) // Comentario original
        ...
        // Crea el objeto Protectora asociado al usuario
        Protectora protectora = new Protectora(usuarioCreado.getId(), imgFile, telefono, email, contrasena, usuarioCreado.getNombre(), direccion, descripcion, imgFile, nombre);

        pm.createProtectora(protectora); // Crea la protectora en su tabla
  ...
  */
  ...
  /**
  * Maneja el evento de clic en el botón "Seleccionar Foto".
  * Abre un selector de archivos para que el usuario elija una imagen para la protectora.
